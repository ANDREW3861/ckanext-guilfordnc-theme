...
def showcases(num=24):
    ...
    try:
        ...
        print "[guilfordnc-theme] Error in retrieving list of showcases"
...
class Guilfordnc-ThemePlugin(plugins.SingletonPlugin):
    ...
    def update_config(self, config_):
        ...
        toolkit.add_resource('fanstatic', 'guilfordnc-theme')

    # ITemplateHelpers

    def get_helpers(self):
        """Register guilfordnc-theme_* helper functions"""
        
        return {'guilfordnc-theme_recent_datasets': recent_datasets,
                'guilfordnc-theme_popular_datasets': popular_datasets,
                'guilfordnc-theme_dataset_count': dataset_count,
                'guilfordnc-theme_get_groups': groups,
                'guilfordnc-theme_get_showcases': showcases,
                'guilfordnc-theme_get_package_metadata': get_package_metadata}